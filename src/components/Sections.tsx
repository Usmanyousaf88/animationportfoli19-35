    ...
    <div className="h-screen overflow-y-scroll snap-y snap-mandatory">
      <section id="raw-materials" className="h-screen snap-start bg-white flex flex-col">
        <div className="flex justify-between p-8">
          <div className="text-2xl font-medium">Armando Sanchez</div>
          <div className="text-2xl font-medium">Design & Marketing Strategist</div>
        </div>
        
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="max-w-4xl">
            <h1 className="text-[200px] font-bold leading-none">AS</h1>
      ...
      <section id="approach" className="h-screen snap-start bg-[#6B46C1] text-white flex items-center justify-center">
        <div className="max-w-4xl p-8">
          <h2 className="text-6xl font-bold mb-8">Approach</h2>
          <p className="text-xl mb-6">
      ...
      <section id="work" className="h-screen snap-start bg-black text-white flex items-center justify-center">
        <div className="max-w-4xl p-8">
          <h2 className="text-6xl font-bold mb-8">Portfolio</h2>
          <p className="text-xl mb-6">
      ...
      <section id="talent" className="h-screen snap-start bg-[#4169E1] text-white flex items-center justify-center">
        <div className="max-w-4xl p-8">
          <h2 className="text-6xl font-bold mb-8">Services & Expertise</h2>
          <div className="text-xl space-y-4">
            <p className="mb-6">I offer a comprehensive suite of design and marketing services, tailored to the needs of small businesses striving to reach broader audiences and make a lasting impression:</p>
      ...
      <section id="careers" className="h-screen snap-start bg-[#FF1493] text-white flex items-center justify-center">
        <div className="max-w-4xl p-8">
          <h2 className="text-6xl font-bold mb-8">Clients & Testimonials</h2>
          <p className="text-xl mb-6">
      ...
      <section id="contact" className="h-screen snap-start bg-[#FFD700] text-black flex items-center justify-center">
        <div className="max-w-4xl p-8">
          <h2 className="text-6xl font-bold mb-8">Contact & Inquiries</h2>
          <p className="text-xl mb-6">
      ...
      <section id="unusual-index" className="h-screen snap-start bg-[#32CD32] text-white flex items-center justify-center">
        <div className="max-w-4xl p-8">
          <h2 className="text-6xl font-bold mb-8">Process & Workflow</h2>
          <p className="text-xl mb-6">
